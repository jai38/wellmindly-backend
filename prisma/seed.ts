...
function phq9Classification(score: number): string {
  ...
  if (!phq9) {
    phq9 = await prisma.quiz.create({
      data: {
        title: 'PHQ-9',
        description:
          'Patient Health Questionnaire-9 is a multipurpose instrument for screening, diagnosing, monitoring and measuring the severity of depression.',
        category: 'Depression',
        totalQuestions: 9,
        maxScore: 27,
      },
