...
exports.WELLBEING_BANDS = exports.WELLBEING_MAX_SCORE = void 0;
exports.bandFor = bandFor;
exports.bandForPercent = bandForPercent;
exports.WELLBEING_MAX_SCORE = 15;
exports.WELLBEING_BANDS = [
    ...
    { id: 'heavy', min: 13, max: exports.WELLBEING_MAX_SCORE, label: 'A heavy couple of weeks' },
];
/** Band for a raw 0-15 total. Clamps rather than throwing. */
function bandFor(score) {
    const s = Number.isFinite(score) ? score : 0;
    if (s <= exports.WELLBEING_BANDS[0].max)
        return exports.WELLBEING_BANDS[0];
    const hit = exports.WELLBEING_BANDS.find((b) => s >= b.min && s <= b.max);
    return hit ?? exports.WELLBEING_BANDS[exports.WELLBEING_BANDS.length - 1];
}
/**
...
function bandForPercent(pct) {
    if (pct >= 80)
        return 'A heavy couple of weeks';
    if (pct >= 50)
        return 'A demanding stretch';
    if (pct >= 20)
        return 'Some rough patches';
