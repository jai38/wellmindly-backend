...
async function getDailyRequestsUsed(userId) {
    ...
    return await prisma_1.default.chatMessage.count({
        where: {
            userId,
            sender: 'USER',
            createdAt: {
...
router.delete('/session/:sessionId', jwt_1.authenticateJWT, (0, jwt_1.authorizeRoles)('STUDENT', 'ADMIN'), async (_req, res) => {
